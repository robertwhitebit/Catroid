...
public class PhiroProMultipleSeekbarFragment extends SherlockFragment implements OnKeyListener {
	...
	private void setUpActionBar() {
		...
		actionBar.setTitle(R.string.phiro_pro_color_chooser_title);
	}
	...
	public static void showMultipleSeekBarFragment(View view, Brick brick, Formula red, Formula green, Formula blue)
	{
		...
		PhiroProMultipleSeekbarFragment formulaEditorMultipleSeekbarFragment = (PhiroProMultipleSeekbarFragment) activity.getSupportFragmentManager()
		...
		if (formulaEditorMultipleSeekbarFragment == null) {
			formulaEditorMultipleSeekbarFragment = new PhiroProMultipleSeekbarFragment();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		phiroProBrick = (LinearLayout) fragmentView.findViewById(R.id.rgb_base_layout);
		...
		redLightBrickTextView = (TextView) fragmentView.findViewById(R.id.brick_phiro_pro_rgb_led_action_red_edit_text);
		greenLightBrickTextView = (TextView) fragmentView.findViewById(R.id.brick_phiro_pro_rgb_led_action_green_edit_text);
		blueLightBrickTextView = (TextView) fragmentView.findViewById(R.id.brick_phiro_pro_rgb_led_action_blue_edit_text);
			...
			public void onProgressChanged(SeekBar seekBar, int i, boolean b) {
				switch(seekBar.getId())
				{
					case R.id.color_rgb_seekbar_red:
						...
						((PhiroProRGBLightBrick)currentBrick).setRedTextValues(seekBar.getProgress());
						break;
					case R.id.color_rgb_seekbar_green:
						formulaEditorEditTextGreen.setText(String.valueOf(seekBar.getProgress()));
						((PhiroProRGBLightBrick)currentBrick).setGreenTextValues(seekBar.getProgress());
						break;
					case R.id.color_rgb_seekbar_blue:
						formulaEditorEditTextBlue.setText(String.valueOf(seekBar.getProgress()));
						((PhiroProRGBLightBrick)currentBrick).setBlueTextValues(seekBar.getProgress());
						break;
					default:
						break;
				}
	...
	public void onPrepareOptionsMenu(Menu menu) {
		...
		getSherlockActivity().getSupportActionBar().setTitle(getString(R.string.phiro_pro_color_chooser_title));
