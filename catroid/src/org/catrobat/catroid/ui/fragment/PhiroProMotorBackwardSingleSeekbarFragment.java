...
public class PhiroProMotorBackwardSingleSeekbarFragment extends SherlockFragment implements OnKeyListener {
	...
	public static final String FORMULA_BUNDLE_ARGUMENT_PHIRO_PRO_MOTOR_SPEED = "speed";
	...
	private int speed;
	private LinearLayout phiroProBrick;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if(getArguments() != null) {
			...
			speedFormula = (Formula) getArguments().getSerializable(FORMULA_BUNDLE_ARGUMENT_PHIRO_PRO_MOTOR_SPEED);
		}
	}
	...
	private void setUpActionBar() {
		...
		actionBar.setTitle(R.string.phiro_pro_motor_backward_title);
	}
	...
	public static void showSingleSeekBarFragment(View view, Brick brick, Formula speed)
	{
		...
		PhiroProMotorBackwardSingleSeekbarFragment formulaEditorSingleSeekbarFragment = (PhiroProMotorBackwardSingleSeekbarFragment) activity.getSupportFragmentManager()
		...
		if (formulaEditorSingleSeekbarFragment == null) {
			formulaEditorSingleSeekbarFragment = new PhiroProMotorBackwardSingleSeekbarFragment();
			Bundle bundle = new Bundle();
			bundle.putSerializable(BRICK_BUNDLE_ARGUMENT, brick);
			bundle.putSerializable(FORMULA_BUNDLE_ARGUMENT_PHIRO_PRO_MOTOR_SPEED, speed);
	...
	private void updateBrickView(Brick newBrick) {
		...
		phiroProBrick.removeAllViews();
		View newBrickView = newBrick.getView(context, 0, null);
		phiroProBrick.addView(newBrickView, new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT,
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		fragmentView = inflater.inflate(R.layout.fragment_phiro_pro_motor_speed_chooser, container, false);
		...
		phiroProBrick = (LinearLayout) fragmentView.findViewById(R.id.motor_base_layout);

		phiroProBrick.addView(brickView, new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT,
				LinearLayout.LayoutParams.MATCH_PARENT));
		...
		OnClickListener onClickListener = new OnClickListener() {
			...
			public void onClick(View view) {
				switch (view.getId())
				{
					case R.id.phiro_pro_motor_speed_value:
		...
		formulaEditorEditTextSpeed = (TextView) fragmentView.findViewById(R.id.phiro_pro_motor_speed_value);
		formulaEditorEditTextSpeed.setOnClickListener(onClickListener);
		speedFormula.setTextFieldId(R.id.phiro_pro_motor_speed_value);

		speedSeekBar = (SeekBar) fragmentView.findViewById(R.id.phiro_pro_motor_speed_seekbar);

		motorActionBrickSpeedTextView = (TextView) fragmentView.findViewById(R.id.brick_phiro_pro_motor_backward_action_speed_edit_text);
		...
		SeekBar.OnSeekBarChangeListener seekBarChangeListener = new SeekBar.OnSeekBarChangeListener() {
			...
			public void onProgressChanged(SeekBar seekBar, int i, boolean b) {
				...
				{
					case R.id.phiro_pro_motor_speed_seekbar:
						formulaEditorEditTextSpeed.setText(String.valueOf(seekBar.getProgress()));
						((PhiroProMotorMoveBackwardBrick)currentBrick).setSpeedTextValue(seekBar.getProgress());
						break;
					default:
						break;
				}
	...
	public void onPrepareOptionsMenu(Menu menu) {
		...
		getSherlockActivity().getSupportActionBar().setTitle(getString(R.string.phiro_pro_motor_backward_title));
