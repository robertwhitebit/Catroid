...
public class PhiroProMotorForwardSingleSeekbarFragment extends SherlockFragment implements OnKeyListener {
	...
	public static final String FORMULA_BUNDLE_ARGUMENT_PHIRO_PRO_PRO_MOTOR_SPEED = "speed";
	...
	private void setUpActionBar() {
		...
		actionBar.setTitle(R.string.phiro_pro_motor_forward_title);
	}
	...
	public static void showSingleSeekBarFragment(View view, Brick brick, Formula speed)
	{
		...
		PhiroProMotorForwardSingleSeekbarFragment formulaEditorSingleSeekbarFragment = (PhiroProMotorForwardSingleSeekbarFragment) activity.getSupportFragmentManager()
		...
		if (formulaEditorSingleSeekbarFragment == null) {
			formulaEditorSingleSeekbarFragment = new PhiroProMotorForwardSingleSeekbarFragment();
			Bundle bundle = new Bundle();
			bundle.putSerializable(BRICK_BUNDLE_ARGUMENT, brick);
			bundle.putSerializable(FORMULA_BUNDLE_ARGUMENT_PHIRO_PRO_PRO_MOTOR_SPEED, speed);
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		motorActionBrickSpeedTextView = (TextView) fragmentView.findViewById(R.id.brick_phiro_pro_motor_forward_action_speed_edit_text);
			...
			public void onProgressChanged(SeekBar seekBar, int i, boolean b) {
				switch(seekBar.getId())
				{
					case R.id.phiro_pro_motor_speed_seekbar:
						...
						((PhiroProMotorMoveForwardBrick)currentBrick).setSpeedTextValue(seekBar.getProgress());
						break;
					default:
						break;
				}
	...
	public void onPrepareOptionsMenu(Menu menu) {
		...
		getSherlockActivity().getSupportActionBar().setTitle(getString(R.string.phiro_pro_motor_forward_title));
