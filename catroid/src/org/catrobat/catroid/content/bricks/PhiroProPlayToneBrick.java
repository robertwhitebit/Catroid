...
public class PhiroProPlayToneBrick extends FormulaBrick implements OnClickListener {
	...
	@Override
	public Brick clone() {
		return new PhiroProPlayToneBrick(toneEnum, getFormulaWithBrickField(BrickField.PHIRO_PRO_DURATION_IN_SECONDS).clone());
	}
	...
	public void onClick(View view) {
		...
		FormulaEditorFragment.showFragment(view, this, getFormulaWithBrickField(BrickField.PHIRO_PRO_DURATION_IN_SECONDS));
	}
