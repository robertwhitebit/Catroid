...
public class PhiroProSetVariableBrick extends FormulaBrick implements OnClickListener, NewVariableDialogListener {
	...
	public Brick copyBrickForSprite(Sprite cloneSprite) {
		...
		PhiroProSetVariableBrick copyBrick = (PhiroProSetVariableBrick) clone();
